...
$result = array(
	...
	'columns' => array (
		...
		'tstamp' => array (
			'exclude' => 1,
            'label'  => DIV2007_LANGUAGE_LGL . 'tstamp',
			'config' => array (
				'type' => 'input',
				'size' => '8',
				'max' => '20',
