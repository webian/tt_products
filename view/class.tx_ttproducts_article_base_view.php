...
abstract class tx_ttproducts_article_base_view extends tx_ttproducts_table_base_view {
	 ...
	 * @return	[type]		...
	 */
	function &getItemSubpartArrays (&$templateCode, &$row, &$subpartArray, &$wrappedSubpartArray, &$tagArray, $theCode='', $id='') {
		global $TCA;
	...
	public function getModelMarkerArray (
		...
		$markerArray['###TAX_INCL_EXCL###'] = ($taxInclExcl ? tx_div2007_alpha5::getLL_fh003($this->langObj, $taxInclExcl) : '');
